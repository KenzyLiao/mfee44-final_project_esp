      ...
      <div className="card mb-4">
        <div className="card-body">
          ...
          <div className="column-content">
            <div className="product-name">開始喜歡寫字</div>
            <div className="card-line" />
            <ul className="product-detail">
              <li className="d-flex justify-content-between">
                <div className="label text-h5">講師：</div>
                <div className="value text-h6 my-auto">王小明</div>
              </li>
              <li className="d-flex justify-content-between">
                <div className="label text-h5">時數：</div>
                <div className="value text-h6 my-auto">118小時</div>
              </li>
              <li className="d-flex justify-content-between">
                <div className="label text-h5">章節：</div>
                <div className="value text-h6 my-auto">87堂</div>
              </li>
            </ul>
